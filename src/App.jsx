  ...
  const cases = [
    {
      ...
      img: './knitted.png',
      img1: './artinpec1.png',
      long: 'Основой для производства фасадов и интерьерных изображений является линейная растровая, поставленная на совершенно новый уровень скульптерами и технологами компании с помощью 3D-трафаретора',
      link: 'untilknitted.ru'
    },
    {
      name: 'Knitted',
      short: 'Онлайн-магазин с крутыми винтажными вещами в Москве',
